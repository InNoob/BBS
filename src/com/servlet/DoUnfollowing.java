...
/**
 * Servlet implementation class DoUnfollowing
 */
@WebServlet("/DoUnfollowing")
public class DoUnfollowing extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DoUnfollowing() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(null!=session.getAttribute("user")){
			if(null!=request.getParameter("uid")){
				int me = Integer.valueOf(((User)session.getAttribute("user")).getUid());
