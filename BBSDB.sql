...
(
	...
	[rid] int not null references recive(rid),
	--这个是评论id
	[eid] int not null references evaluat(eid)
)
go
...
as
	begin tran
	begin try
		declare @m int = (select mark+@mark from userinfo where uid = @uid)
		declare @l int = (select 100*power(2,level) from userinfo where uid = @uid)
		if(@m>=@l)
...
(@bid int,@uid int,@title nvarchar(128),@content ntext
...
as
	...
	begin try
		...
		(@bid,CONVERT(int,IDENT_CURRENT('topic')),@uid,@content,default,0,@attach,@tag)
...
go
drop proc proc_createUser
go
create proc proc_createUser 
(@password nvarchar(50),@email nvarchar(50))
as
	insert into userinfo values('',@password,0,default,null,@email,'resource/image/pic.jpg',0,0,N'这个人很懒，什么都没有留下',default,null)
	update userinfo set username = 'User_'+CAST(CONVERT(int,IDENT_CURRENT('userinfo')) as varchar) where uid = CONVERT(int,IDENT_CURRENT('userinfo'))
go


EXEC proc_createUser N'123123',N'123123@qq.com'
EXEC proc_createUser N'777777',N'777777@qq.com'
EXEC proc_createUser N'111111',N'111111@qq.com'
EXEC proc_createUser N'321321',N'321321@qq.com'
EXEC proc_createUser N'654321',N'654321@qq.com'
EXEC proc_createUser N'222222',N'222222@qq.com'
EXEC proc_createUser N'333333',N'333333@qq.com'
EXEC proc_createUser N'444444',N'444444@qq.com'
EXEC proc_createUser N'555555',N'555555@qq.com'

--添加版块 标题 状态码 时间 备注
insert into block values(N'技术交流',1,default,null)
insert into block values(N'日常生活',1,default,null)
insert into block values(N'资源分享',1,default,null)
insert into block values(N'官方公告',1,default,null)
go
...
EXEC proc_creatTopic 1,1002,N'震惊',N'真想竟然是这样',NULL,NULL
EXEC proc_creatTopic 2,1003,N'男默女泪',N'真特么感人',NULL,NULL
EXEC proc_creatTopic 3,1005,N'99%的人都不知道',N'你是哈巴卵',NULL,NULL
EXEC proc_creatTopic 4,1006,N'气不气',N'我看你妈洗澡',NULL,NULL

EXEC proc_creatRecive 1,1,1000,1002,N'狗主编',NULL,null
EXEC proc_creatRecive 1,1,1001,1002,N'狗',NULL,null
EXEC proc_creatRecive 2,2,1004,1003,N'狗东西',NULL,null
EXEC proc_creatRecive 3,3,1007,1005,N'垃圾',NULL,null
EXEC proc_creatRecive 4,4,1008,1006,N'没脑子',NULL,null
EXEC proc_creatRecive 4,4,1009,1006,N'哈巴乱',NULL,null

EXEC proc_creatEvaluat 1,1,1,1001,1000,N'没错',NULL,NULL
EXEC proc_creatEvaluat 2,2,3,1001,1004,N'就是',NULL,NULL
EXEC proc_creatEvaluat 3,3,4,1001,1007,N'嗯',NULL,NULL
EXEC proc_creatEvaluat 4,4,5,1001,1008,N'同意',NULL,NULL
EXEC proc_creatEvaluat 1,1,2,1007,1001,N'支持',NULL,NULL
EXEC proc_creatEvaluat 1,1,1,1002,1000,N'别这样嘛',NULL,NULL

EXEC proc_creatRevaluat 1,1,1,1,1007,1001,N'骂得好',NULL,null

EXEC proc_creatMessage 1003,1002,N'来UC震惊部上班吧',NULL,null
